...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-decoders", type=int, help="Number of decoders")
    parser.add_argument("--n-blocks", type=int, help="Number of decoder blocks (groups of decoders); must evenly divide n-decoders")
    parser.add_argument("--depth-attention", action="store_true", help="Add a depth-wise attention residual over earlier blocks' cached output")
