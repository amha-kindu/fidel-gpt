...
if __name__ == "__main__":
    ...
    parser.add_argument("--metric-rank", type=int, help="Rank of each mode's off-diagonal perturbation matrix for the Riemannian metric (default: head_dim)")
    parser.add_argument("--metric-modes", type=int, help="Number of independently-gated dimensional couplings (modes) summed into the Riemannian metric's off-diagonal (default: 1)")
